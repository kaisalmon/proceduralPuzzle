...
var PuzzleState = /** @class */ (function () {
    ...
    PuzzleState.prototype.print_stack = function (depth, debug) {
        ...
        stack.reverse().forEach(function (e) { return console.log(e.toString()); });
    };
    return PuzzleState;
}());
/*******************************************/
...
var BoulderPuzzle = /** @class */ (function (_super) {
    ...
    BoulderPuzzle.prototype.isPassable = function (tile) {
        ...
        for (var _i = 0, _a = state.boulders; _i < _a.length; _i++) {
            ...
            //Encapsulate some logic here
            {
                for (var mag_1 = 1; mag_1 < this.height; mag_1++) {
                    if (this.isPassable(this.getTile(ox + vec[0] * mag_1, oy + vec[1] * mag_1))) {
                        mags.push(mag_1);
                    }
                    else {
                        break;
